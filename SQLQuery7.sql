...
( select MaMP from Asm4_MUCPHIS where Dongia = 15 ) ) or (Dongxe in (select Dongxe from Asm4_DONGXES where Hangxe like 'KIA' )
...
select * from Asm4_NHACUNGCAPS where MaNhaCC in 
(select MaNhaCC from Asm4_DANGKYDICHVUS where Dongxe like null );